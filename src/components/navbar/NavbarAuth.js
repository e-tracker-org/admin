  ...
  let brand = (
    <Link
      ...
      <Stack direction='row' spacing='12px' align='center' justify='center'>
        {/* <RequisiteLogo h='26px' w='175px' color={logoColor} /> */}
        <Image src={navImage}  h='26px' w='175px' my='32px' mb='28px' />
      </Stack>
  ...
  if (props.secondary === true) {
    brand = (
      <Link
        ...
        color={mainText}>
          <Image src={navImage}  h='26px' w='175px' my='32px' mb='28px' />
        {/* <RequisiteLogo h='26px' w='175px' my='32px' color={logoColor} /> */}
      </Link>
    );
    // mainText = useColorModeValue("gray.700", "gray.200");
    // navbarBg = useColorModeValue("white", "#4A154B");
